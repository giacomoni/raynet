...
int RoutingTableParserEcmp::strcpyword(char *dest, const char *src)
{
    int i;
...
int RoutingTableParserEcmp::readRoutingTableFromFile(const char *filename)
{
...
void RoutingTableParserEcmp::parseInterfaces(char *ifconfigFile)
{
...
void RoutingTableParserEcmp::parseMulticastGroups(char *groupStr, InterfaceEntry *itf)
{
...
void RoutingTableParserEcmp::parseRouting(char *routeFile)
{
