...
#include "Ipv4NodeConfiguratorEcmp.h"

namespace inet {

Define_Module(Ipv4NodeConfiguratorEcmp);

Ipv4NodeConfiguratorEcmp::Ipv4NodeConfiguratorEcmp()
{
    nodeStatus = nullptr;
...
void Ipv4NodeConfiguratorEcmp::initialize(int stage)
{
...
void Ipv4NodeConfiguratorEcmp::prepareAllInterfaces()
{
...
void Ipv4NodeConfiguratorEcmp::configureAllInterfaces()
{
