...
#ifndef COMMON_TOPOLOGYECMP_H_
#define COMMON_TOPOLOGYECMP_H_
...
class INET_API TopologyEcmp : public cOwnedObject
{
public:
    class Link;
    class LinkIn;
    ...
    public:
        ...
        std::vector<Link*> outPathEcmp; // MOH: added
        ...
        {
            return getSimulation()->getModule(moduleId);
        }
        ...
        {
            return (LinkOut*) outPath;
        }      //FIXME check_and_cast?
        //@}

        LinkOut* getPathECMP(int n) const
        {
            return (LinkOut*) outPathEcmp[n];
        }
    };
    ...
    public:
        ...
        {
            return srcNode->getModule()->gate(srcGateId);
        }
        ...
        {
            return destNode->getModule()->gate(destGateId);
        }
    };
...
public:
     ...
     * Copy constructor.
     */
    TopologyEcmp(const TopologyEcmp &topo);
     ...
     */
    TopologyEcmp& operator=(const TopologyEcmp &topo);
    //@}
     ...
     */
    virtual TopologyEcmp* dup() const override
    {
        return new TopologyEcmp(*this);
    }
